...
/** Class encapsulating Starkcoin Core startup and shutdown.
...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        WinShutdownMonitor::registerShutdownBlockReason(QObject::tr("Starkcoin Core didn't yet exit safely..."), (HWND)app.getMainWinId());
#endif
        app.exec();
        app.requestShutdown();
        app.exec();
