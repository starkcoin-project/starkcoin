    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Starkcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Starkcoin Core"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About Starkcoin Core"), this);
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Starkcoin Core help message to get a list with possible Bitcoin command-line options"));
